...
| **B3** | **A fresh export carrying the v1.5.1 config** — preferred vehicle for B1, and it would also exercise the `measure` path and an exterior zone, neither of which any export has ever exercised. | — |
